...
const colors = {
  ...
  accent: [
    '[--switch-bg-ring:var(--color-accent-600)]/90 [--switch-bg:var(--color-accent-500)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-accent-600)]/90 [--switch-shadow:var(--color-accent-900)]/20',
  ],
  violet: [
