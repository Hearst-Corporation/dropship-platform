...
const colors = {
  citrus: 'bg-citrus-500/15 text-citrus-700 group-data-hover:bg-citrus-500/25 dark:bg-citrus-500/10 dark:text-citrus-400 dark:group-data-hover:bg-citrus-500/20',
