...
const colors = {
  citrus: [
    '[--switch-bg-ring:var(--color-citrus-600)]/80 [--switch-bg:var(--color-citrus-500)] dark:[--switch-bg-ring:transparent]',
    '[--switch-ring:transparent] [--switch-shadow:transparent] [--switch:var(--color-zinc-950)]',
  ],
  'dark/zinc': [
