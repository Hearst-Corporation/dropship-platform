...
export const MOCK_PRODUCTS: StoreProduct[] = [
  mockProduct(0, 'Essence Lumineuse', "Sérum éclat à l'huile de rosier. Texture fondante, parfum naturel délicat.", 4900),
  mockProduct(1, 'Crème Velours', 'Hydratation intense 72h. Formule vegan certifiée. Peaux sensibles et normales.', 3500),
  mockProduct(2, 'Ritual Masque', "Masque purifiant à l'argile blanche. Pores affinés, teint unifié en 15 minutes.", 2800),
  mockProduct(3, 'Élixir Nuit', 'Concentré repulpant nocturne. Active la régénération cellulaire pendant le sommeil.', 5900),
  mockProduct(4, 'Brume Protectrice', 'Voile protecteur UV 30. Fixateur de maquillage et soin en un geste.', 2200),
  mockProduct(5, 'Baume Lèvres', "Soin lèvres fondant à la cire d'abeille et miel de manuka. 100% naturel.", 1500),
];
...
export function buildMockStore(templateId: string, label: string): StoreConfig {
  return {
    ...
    description: 'Une sélection rigoureuse de soins naturels pour sublimer votre routine quotidienne.',
    primaryColor: '#18181b',
    ...
    landingContent: {
      ...
      trust_promises: [
        { title: 'Certifié vegan', body: "Aucun ingrédient d'origine animale, aucun test sur les animaux." },
        { title: 'Packaging recyclé', body: 'Tous nos emballages sont fabriqués en plastique recyclé ou en verre.' },
        { title: 'Made in France', body: 'Formulé et produit en France, sous contrôle qualité strict.' },
        { title: 'Dermatologiquement testé', body: 'Cliniquement testé sur peaux sensibles. Résultats mesurés après 28 jours.' },
      ],
      final_cta: {
