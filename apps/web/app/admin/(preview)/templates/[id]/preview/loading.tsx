export default function Loading() {
  ...
  return (
    <div className="min-h-screen bg-white/[0.03]">
      {/* Admin header bar */}
      <div className="sticky top-0 z-50 flex items-center gap-3 border-b border-white/[0.12] bg-white/[0.95] px-4 py-2.5">
        <div className="h-4 w-20 animate-pulse rounded bg-white/[0.03]" />
        <div className="h-4 w-40 animate-pulse rounded bg-white/[0.03]" />
        <div className="h-5 w-24 animate-pulse rounded bg-white/[0.03]" />
        <div className="ml-auto h-5 w-44 animate-pulse rounded-full bg-white/[0.03]" />
      </div>

      {/* Storefront hero */}
      <div className="aspect-[21/9] w-full animate-pulse bg-white/[0.03]" />

      {/* Product grid */}
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="mb-8 space-y-3">
          <div className="h-8 w-80 animate-pulse rounded-md bg-white/[0.03]" />
