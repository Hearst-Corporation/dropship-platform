  ...
  return (
    <div className="animate-pulse space-y-8" aria-hidden="true">
      ...
      <div className="min-w-0 space-y-2">
        ...
        <div className="h-7 w-64 rounded bg-white/[0.03]" />
      ...
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="rounded-xl border border-white/[0.08]">
          <div className="space-y-2 border-b border-white/[0.08] px-5 py-4 sm:px-6 border-white/[0.08]">
            <div className="h-5 w-48 rounded bg-white/[0.03]" />
            <div className="h-3 w-80 max-w-full rounded bg-white/[0.03]" />
          </div>
          <div className="space-y-4 p-5 sm:p-6">
            <div className="h-9 w-full max-w-sm rounded-lg bg-white/[0.03]" />
