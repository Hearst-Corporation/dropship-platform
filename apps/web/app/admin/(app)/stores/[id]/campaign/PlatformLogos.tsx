 ...
 * added: Instagram and TikTok use the official simple-icons glyph paths,
 * Google Ads is the official three-shape mark (two rounded bars + dot)
 * rebuilt geometrically. Brand colors are allowed HERE by explicit operator
 * decision (exception to the single-accent admin rule, scoped to this page).
 */
...
export function GoogleAdsLogo({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden className={className}>
      {/* Barre jaune, du bas gauche vers le sommet. */}
      <rect
        x="5.4"
        y="1.8"
        width="6"
        ...
        rx="3"
        fill="#FBBC04"
        transform="rotate(30 8.4 12)"
      />
      {/* Barre bleue, du sommet vers le bas droit. */}
      <rect
        x="12.6"
        y="1.8"
        width="6"
        ...
        rx="3"
        fill="#4285F4"
        transform="rotate(-30 15.6 12)"
      />
      {/* Point vert en bas à gauche. */}
      <circle cx="4.35" cy="19.2" r="3" fill="#34A853" />
    </svg>
  );
}
...
/** TikTok est #010101; sur l'admin sombre le glyphe passe en blanc. */
