...
export function NicheResearchCopilot({
  ...
  return (
    <section className={cn("rounded-xl border overflow-hidden flex flex-col flex-1 min-h-0", adminBorder, adminBgPanel)}>
      <header className={cn("px-4 py-2 flex items-center justify-between gap-3 shrink-0 border-b", adminBorder)}>
        <div className="flex items-baseline gap-3 min-w-0">
          <h2 className={cn("text-sm font-semibold tracking-tight shrink-0", adminText)}>
            Copilote <em className={cn("italic", adminTextMuted)}>de niches</em>
          </h2>
          {messageCount > 0 && (
            <span className={cn("text-[11px] truncate", adminTextMuted)}>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <Select
            ...
            className="!w-auto max-w-[200px] text-xs"
          >
